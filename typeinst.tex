...
\begin{figure}[htp]
  \begin{center}
    \subfigure[102 clicks as of Bit.ly.]{\label{fig:edge-a}\includegraphics[width=0.75\linewidth]{bitly.png}}
    \subfigure[1,009 absolute Pageviews as of Analytics.]{\label{fig:edge-b}\includegraphics[width=0.75\linewidth]{all-traffic.png}}
  \end{center}
